                ...
                <div class="col-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h4 class="box-title">Edit Pasien</h4>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_kelamin" id="jenis_kelamin"
                                                ...
                                                <option value="L"
                                                    {{ old('jenis_kelamin') == 'L' ? 'selected' : ($pasien->jenis_kelamin == 'L' ? 'selected' : '') }}>
                                                    Laki-Laki</option>
                                                <option value="P"
                                                    {{ old('jenis_kelamin') == 'P' ? 'selected' : ($pasien->jenis_kelamin == 'P' ? 'selected' : '') }}>
                                                    Perempuan</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kelurahan_id" id="kelurahan_id"
                                                class="form-control {{ $errors->has('kelurahan_id') ? ' is-invalid' : '' }}">
                                                @foreach ($kelurahan as $kelurahan)
                                                    <option value="{{ $kelurahan->id }}"
                                                        {{ old('kelurahan_id') == $kelurahan->id? 'selected': ($pasien->kelurahan_id == $kelurahan->id? 'selected': '') }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" id="alamat" cols="30" rows="5"
                                                class="form-control {{ $errors->has('alamat') ? ' is-invalid' : '' }}">{{ old('alamat') ? old('alamat') : $pasien->alamat }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="no_hp" name="no_hp"
                                                ...
                                                value="{{ old('no_hp') ? old('no_hp') : $pasien->no_hp }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                                ...
                                                value="{{ old('tanggal_lahir') ? old('tanggal_lahir') : $pasien->tanggal_lahir }}">
